...
@section('content')
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('designs.index') }}" class="text-sm text-gray-600 hover:text-orange-500">&larr; Kembali ke Daftar Desain</a>
    </div>
    ...
    <form action="{{ route('designs.update', $design->id) }}" method="POST" enctype="multipart/form-data" class="card p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            <label for="design_file" class="block text-sm font-medium text-gray-700 mb-1">Ganti File Desain (Gambar: JPG, PNG, WEBP)</label>
            @if($design->file_path)
                <div class="mb-2">
